...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "courrier@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "courrier API";

        private String description = "courrier API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "courrier";
